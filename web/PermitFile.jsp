  ...
  <div id="outer2">
    ...
    <div id="content">
      ...
      <style>
                                                      ...
                                                      <h2 style="color:red;">Permit Files And Send To Cloud</h2>
    ...
    ResultSet r=st.executeQuery("select * from proxy where status='Permitted' and cloud='waiting'");
        ...
        while(r.next()){
          ...
          <tr>
              ...
              <td><%=r.getString("user")%></td>
                  ...
                  <td><a href="SendToCloud.jsp?id=<%=r.getString("id")%>&fname=<%=r.getString("fname")%>&user=<%=r.getString("user")%>">No</a></td>    
