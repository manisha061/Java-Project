...
<div id="outer">
  <div id="outer2">
    ...
    <div id="content">
      <div id="column1">
          <h2>Welcome to Data Owner Registration</h2>
         <img src="images/user.jpeg" align="right" style="margin-top: 100px;" height=""></img>
        <form name="login" action="DataOwnerRegAction.jsp" method="post">
            <table style="margin-top: 50px; font-size:20px;" height="400px" bgcolor="orange" width="300px">
         ...
         <p style="margin: 50px; font-size:20px;">Already Data Owner&nbsp;&nbsp;&nbsp;<a href="dataOwner.jsp">Click Here</a></p>
      </div>
