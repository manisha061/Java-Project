...
<div id="outer">
    ...
    <div id="content" >
      <div id="column1" style="border:1px solid red;width:200px;float:right;height:300px;border-radius:10px; ">
        ...
        <li><a href="index.html">Logout</a></li>
          ...
          <%
          String oname=request.getParameter("uname");
  ...
  ResultSet r=st.executeQuery("select * from keyrequest where username='"+username+"' and fname='"+fname+"' and status='"+searchKey+"'");
        if(r.next()){
     ResultSet r1=st1.executeQuery("select * from files where fname='"+fname+"'");
         if(r1.next()){
