...
<div id="outer">
  <div id="outer2">
    ...
    <div id="content">
     ...
     <h2 style="color:red;">View Search key Request</h2>
    ...
    ResultSet r=st.executeQuery("select * from keyrequest where status='waiting'");
        ...
        while(r.next()){
          ...
          <tr>
           ...
           if(status.equals("waiting")){
               %>
               <td><a href="GenerateSKey.jsp?id=<%=r.getString("id")%>">Generate</a></td>  
               <%
           }else{
%>
               <td><%=status%></td>   
