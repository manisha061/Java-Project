    ...
    <div id="content" >
      <div id="column1" style="border:1px solid red;width:200px;float:right;height:300px;border-radius:10px; ">
        ...
        <li><a href="index.html">Logout</a></li>
          ...
          <center><h2 style="color:red;">Download Content</h2></center>
           ...
           <style>
                                                      ...
                                                      <form action="ViewContent2.jsp" method="post">                                             
       ...
       <tr><th>UserName:</th><td><input type="text" name="uname" value="<%=username%>" readonly=""/></td></tr> 
                <tr><th>Enter File Name:</th><td><input type="text" name="fname" value="<%=fname%>" readonly=""/></td></tr> 
         <tr><th>Search Key:</th><td><input type="text" name="searchKey" required=""/></td></tr> 
        <tr><th></th><td><input type="submit" value="View Content"/></td></tr> 
