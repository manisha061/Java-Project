...
<div id="outer">
  <div id="outer2">
    ...
    <div id="content">
      ...
      %>
          <center><h2 style="color:red;border:none;">View All Transactions</h2></center>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <table style="margin-bottom:200px;" border="2px" >
          <tr>
              <th>User</th>
              <th>File Name</th>
              <th>Task</th>
...
ResultSet rs1=st1.executeQuery("select * from download");  
          while(rs1.next()){
          %>
          <tr>
